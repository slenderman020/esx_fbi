...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('fbi',0,'recruit','Agente Raso',1000,'{}','{}'),
	('fbi',1,'recruit','Agente Experimentado',1200,'{}','{}'),
	('fbi',2,'recruit','Agente de Primera',1300,'{}','{}'),
	('fbi',3,'officer','Coodinador de Agentes',1700,'{}','{}'),
	('fbi',4,'officer','Subinspector Federal',1900,'{}','{}'),
	('fbi',5,'officer','Inspector Federal',2100,'{}','{}'),
	('fbi',6,'sergeant','Subdirector de Operaciones',2300,'{}','{}'),
	('fbi',7,'sergeant','Subdirector de Inteligencia',2400,'{}','{}'),
	('fbi',8,'sergeant','Director de Operaciones',2600,'{}','{}'),
	('fbi',9,'sergeant','Director de Inteligencia',2600,'{}','{}'),
	('fbi',10,'boss','Subirector General',3200,'{}','{}'),
	('fbi',11,'boss','Director General',3600,'{}','{}')
;

CREATE TABLE `fine_types_fbi` (
...
INSERT INTO fine_types_fbi (id,label,amount,category) VALUES
