local CurrentActionData, handcuffTimer, dragStatus, blipsCopsFBI, currentTask = {}, {}, {}, {}, {}
...
function createBlip(id)
	...
	if not DoesBlipExist(blip) then -- Add blip and create head display on player
		...
		table.insert(blipsCopsFBI, blip) -- add blip to array so we can remove it later
	end
end
...
AddEventHandler('esx_fbijob:updateBlip', function()
	...
	-- Refresh all blips
	for k, existingBlip in pairs(blipsCopsFBI) do
